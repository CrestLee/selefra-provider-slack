# Selefra Provider Slack

Use this repo as a raw reference to **tables and schema** for Slack usage. [Here's](https://github.com/selefra/selefra-provider-slack/blob/main/docs/tables/slack.md) a summary of full coverage. 
